...
public class ExportExecutionDescriptorTest {
    @Test
    @Parameters({
            "exportId",
            "status",
    ...
    public void shouldHaveExposeAnnotationForField(String fieldName) throws NoSuchFieldException {
        Field field = ExportExecutionDescriptor.class.getDeclaredField(fieldName);
    ...
    public void exportIdFieldShouldHaveSerializedNameAnnotationForField() throws NoSuchFieldException {
        Field field = ExportExecutionDescriptor.class.getDeclaredField("exportId");
