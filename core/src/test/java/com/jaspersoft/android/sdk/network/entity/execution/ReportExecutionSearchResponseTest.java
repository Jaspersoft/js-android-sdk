...
public class ReportExecutionSearchResponseTest {
    @Test
    @Parameters({
            "items",
    })
    ...
    public void valuesFieldShouldHaveSerializedNameAnnotationForField() throws NoSuchFieldException {
        Field field = ReportExecutionSearchResponse.class.getDeclaredField("items");
        assertThat(field, hasSerializedName("reportExecution"));
    }
}
