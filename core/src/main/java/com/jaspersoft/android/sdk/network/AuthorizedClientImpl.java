 ...
 * @since 2.0
 */
final class AuthorizedClientImpl extends AbstractClient implements AuthorizedClient {
    ...
    AuthorizedClientImpl(Retrofit retrofit, AnonymousClient anonymousClient) {
        super(retrofit);
    ...
    public ReportExecutionRestApi reportExecutionApi() {
        if (mReportExecutionRestApi == null) {
            mReportExecutionRestApi = new ReportExecutionRestApiImpl(mRetrofit);
        }
    ...
    public ReportExportRestApi reportExportApi() {
        if (mReportExportRestApi == null) {
            mReportExportRestApi = new ReportExportRestApiImpl(mRetrofit);
        }
    ...
    public ReportOptionRestApi reportOptionsApi() {
        if (mReportOptionRestApi == null) {
            mReportOptionRestApi = new ReportOptionRestApiImpl(mRetrofit);
        }
    ...
    public InputControlRestApi inputControlApi() {
        if (mInputControlRestApi == null) {
            mInputControlRestApi = new InputControlRestApiImpl(mRetrofit);
        }
    ...
    public RepositoryRestApi repositoryApi() {
        if (mRepositoryRestApi == null) {
            mRepositoryRestApi = new RepositoryRestApiImpl(mRetrofit);
        }
