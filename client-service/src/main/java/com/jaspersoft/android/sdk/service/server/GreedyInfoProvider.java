 ...
 * @since 2.0
 */
public final class GreedyInfoProvider implements InfoProvider {
    ...
    public static GreedyInfoProvider newInstance(ServerService serverService) {
        return new GreedyInfoProvider(serverService);
    }
