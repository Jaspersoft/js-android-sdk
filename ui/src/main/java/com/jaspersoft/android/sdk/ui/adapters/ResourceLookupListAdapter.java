...
/**
 * A concrete ArrayAdapter for a {@link android.widget.ListView}
 * that is backed by an array of ResourceLookup objects.
 *
 * @author Ivan Gadzhega
 * @since 2.0
 */
public class ResourceLookupListAdapter extends ArrayAdapter<ResourceLookup>{
    private final Context context;
    private final List<ResourceLookup> resourceLookups;
    private String datetimeFormatPattern = "yyyy-MM-dd HH:mm:ss";

    public ResourceLookupListAdapter(Context context, List<ResourceLookup> resourceLookups) {
