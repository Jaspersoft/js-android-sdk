...
abstract class TemplateInitiator {
    ...
    final void initiateTemplate(final WebView webView, final JasperReportView.InflateCallback inflateCallback) {
    ...
    abstract void beforeTemplateLoaded(WebView webView, final JasperReportView.InflateCallback callback);

    abstract void afterTemplateLoaded(WebView webView, JasperReportView.InflateCallback callback);

    private void setupCallback(final WebView webView, final JasperReportView.InflateCallback inflateCallback) {
