 ...
 * @since 1.12
 */
public class GetReportOptionResourceRequest extends CacheableRequest<ReportOptionLookup> {

    private String uri;

    /**
     * Creates a new instance of {@link GetReportOptionResourceRequest}.
     * @param uri file URI (e.g. /reports/samples/)
     */
    public GetReportOptionResourceRequest(JsRestClient jsRestClient, String uri) {
        super(jsRestClient, ReportOptionLookup.class);
        this.uri = uri;
    }

    @Override
    public ReportOptionLookup loadDataFromNetwork() throws Exception {
        return getJsRestClient().getReportOptionDescriptor(uri);
    }
